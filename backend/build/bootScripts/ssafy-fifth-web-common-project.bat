...
set JARPATH=%APP_HOME%\lib\ssafy-fifth-web-common-project-1.0-SNAPSHOT.jar

@rem Execute ssafy-fifth-web-common-project
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SSAFY_FIFTH_WEB_COMMON_PROJECT_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
